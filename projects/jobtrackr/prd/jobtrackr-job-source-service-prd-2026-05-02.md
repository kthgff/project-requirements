...
- Search profile fields:
  ...
  - include keywords
  - exclude keywords
- Multiple search profiles per user
...
- User-triggered manual run-now control unless added later
...
- create multiple search profiles
...
- User can set title, location, remote preference, salary, seniority, employment type, and include/exclude keywords
