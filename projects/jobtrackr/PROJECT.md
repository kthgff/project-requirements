...
- Current sourced-jobs UI validation handoff: start from the T-162 QA evidence index at `projects/jobtrackr/specs/jobtrackr-t162-sourced-jobs-ui-qa-evidence-index-2026-05-03.md`; it maps the T-154 ordered `/jobs` walkthrough, T-159 evidence pointers, T-160 repo-side evidence pass, and T-161 visual capture handoff for source chips, merged provenance, source filters, empty states, and drawer/full-detail continuity
...
- Current QA and debug handoff docs for provenance work:
  ...
  - `projects/jobtrackr/specs/jobtrackr-t163-source-service-provenance-qa-evidence-index-2026-05-03.md` for the T-163 Sam-facing evidence index that collects source-service schema, merge, connector, source-run, and T-108 debug-read proof from one path
